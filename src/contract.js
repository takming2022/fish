...
export const contractInstance_singner = new ethers.Contract(address, abi, signer);
//使用singer 連接合約 對合約有可讀寫權限
export const contractInstance_provider = new ethers.Contract(address,abi,provider);
